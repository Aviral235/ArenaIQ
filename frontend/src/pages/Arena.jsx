...
export default function Arena() {
  ...
  return (
    <div ref={pageRef} className="page-container" style={{ minHeight: '100vh' }}>
      {/* Header */}
      <div className="page-header">
        ...
        <p ref={subRef} className="page-subtitle">
      ...
      <div ref={formRef} className="page-body">
        {/* Model selectors */}
        <div className="arena-model-selectors">
          <div>
          ...
          <div className="hidden sm:flex" style={{ alignItems: 'center', justifyContent: 'center', paddingBottom: '6px' }}><span className="gradient-text" style={{ fontFamily: "'Poppins',sans-serif", fontSize: '1.6rem', fontWeight: 700 }}>VS</span></div>
          <div>
        ...
        {/* Prompt */}
        <div className="arena-prompt-container">
            ...
            <motion.div key="results" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: 'easeOut' }}>
              ...
              {!voted ? (
                <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.4 }} className="glass-card">
                  <label className="form-label" style={{ marginBottom: '12px' }}>🗳️ Which response do YOU prefer?</label>
